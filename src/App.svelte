...
<main class="overflow-hidden bg-gray-900 text-white">
    <div class="min-h-screen bg-gray-900 text-white relative">
        ...
        <div class="relative z-20">
            ...
            <div class="container mx-auto px-4 mb-16 max-w-3xl">
                <div class="bg-gray-800/40 backdrop-blur-sm p-8 rounded-xl border border-yellow-500/30 shadow-lg">
                    <div class="flex items-center gap-3 mb-4">
                        <svg class="w-6 h-6 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <h3 class="text-2xl font-bold text-yellow-400">A Message From Our Founder</h3>
                    </div>
                    <div class="space-y-4 text-gray-300">
                        ...
                        <div class="pt-4 border-t border-gray-700/50 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div>
                                <p class="font-semibold text-white text-lg">Steve</p>
                                <p class="text-sm text-gray-400">Founder, Skill Kenya</p>
                            </div>
                            <a href="https://wa.me/254758481320" target="_blank"
                               class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-green-500/50">
